...
std::unique_ptr<rhoban_fa::FunctionApproximator> ExtraTreesApproximator::train(
    ...
    std::default_random_engine* engine)
{
  ...
  Eigen::MatrixXd inputs = rhoban_random::getUniformSamplesMatrix(problem.getStateLimits(), nb_samples, engine);
