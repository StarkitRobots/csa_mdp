...
void PolicyMutationLearner::fromJson(TiXmlNode* node)
{
  ...
  starkit_utils::xml_tools::try_read<bool>(node, "avoid_growing_slopes", avoid_growing_slopes);
  starkit_utils::xml_tools::try_read<bool>(node, "use_visited_states", use_visited_states);
  starkit_utils::xml_tools::try_read<int>(node, "training_evaluations", training_evaluations);
  starkit_utils::xml_tools::try_read<double>(node, "training_evaluations_growth", training_evaluations_growth);
  starkit_utils::xml_tools::try_read<double>(node, "split_probability", split_probability);
  starkit_utils::xml_tools::try_read<double>(node, "local_probability", local_probability);
  starkit_utils::xml_tools::try_read<double>(node, "narrow_probability", narrow_probability);
  starkit_utils::xml_tools::try_read<double>(node, "split_margin", split_margin);
  starkit_utils::xml_tools::try_read<double>(node, "evaluations_ratio", evaluations_ratio);
  starkit_utils::xml_tools::try_read<double>(node, "evaluations_growth", evaluations_growth);
  starkit_utils::xml_tools::try_read<double>(node, "age_basis", age_basis);
  starkit_utils::xml_tools::try_read<double>(node, "change_action_probability", change_action_probability);
  // Optimizer is mandatory
  optimizer = starkit_bbo::OptimizerFactory().read(node, "optimizer");
                                                                     ...
                                                                     std::default_random_engine* engine)
{
  ...
  {
    return starkit_random::getUniformSamples(mc.space, nb_evaluations_allowed, engine);
  }
