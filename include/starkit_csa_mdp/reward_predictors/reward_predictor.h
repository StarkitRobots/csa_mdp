...
namespace csa_mdp
{
class RewardPredictor : public starkit_utils::JsonSerializable
{
public:
  RewardPredictor();
  ...
  virtual void predict(const Eigen::VectorXd& input, const Policy& policy, Problem::ResultFunction result_function,
